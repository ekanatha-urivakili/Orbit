...
namespace Orbit.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260824203140_AddBacklogViewPreference")]
    partial class AddBacklogViewPreference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orbit.Domain.Access.ProjectGroupRoleAssignment", b =>
                {
                    ...
                    b.ToTable("project_group_role_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("Orbit.Domain.Access.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Orbit.Domain.Access.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uuid")
                        .HasColumnName("role_id");
            ...
            modelBuilder.Entity("Orbit.Domain.Configuration.WorkItemStatusDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("work_item_status_definitions", null, t =>
                        {
                            t.HasCheckConstraint("ck_work_item_status_definitions_order", "\"order\" BETWEEN 0 AND 100000");

                            t.HasCheckConstraint("ck_work_item_status_definitions_version", "version > 0");
                        });
                });
            ...
            modelBuilder.Entity("Orbit.Domain.Integrations.SlackConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("EncryptedWebhookUrl")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("encrypted_webhook_url");
            ...
            modelBuilder.Entity("Orbit.Domain.Messaging.AttachmentScanRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ProcessedAt", "Attempts", "CreatedAt");

                    b.ToTable("attachment_scan_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Orbit.Domain.Settings.BacklogViewPreference", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_id");
                    ...
                    b.PrimitiveCollection<string[]>("HiddenFields")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("hidden_fields");

                    b.Property<bool>("ShowEmptySprints")
                        .HasColumnType("boolean")
                        .HasColumnName("show_empty_sprints");
                    ...
                    b.HasKey("TenantId", "UserId", "ProjectId");

                    b.HasIndex("UserId");

                    b.HasIndex("TenantId", "ProjectId");

                    b.ToTable("backlog_view_preferences", (string)null);
                });

            modelBuilder.Entity("Orbit.Domain.Settings.BoardViewPreference", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_id");
                    ...
                    b.Property<string>("ColumnSizeMode")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("column_size_mode");
                    ...
                    b.Property<string>("HideDoneItemsAfter")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("hide_done_items_after");
                    ...
                    b.ToTable("board_view_preferences", (string)null);
                });
            ...
            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItem", b =>
                {
                    ...
                    b.Property<Guid?>("CoverAttachmentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ProjectId", "Rank");

                    b.HasIndex("TenantId", "ProjectId", "StatusId", "Rank");
            ...
            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItemCustomFieldValue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "CustomFieldDefinitionId");

                    b.HasIndex("TenantId", "WorkItemId", "CustomFieldDefinitionId")
                        .IsUnique()
                        .HasDatabaseName("ux_work_item_custom_field_values_tenant_item_field");

                    b.ToTable("work_item_custom_field_values", (string)null);
                });

            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItemHistoryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "WorkItemId", "ChangedAt")
                        .HasDatabaseName("ix_work_item_history_entries_tenant_item_changed");

                    b.ToTable("work_item_history_entries", (string)null);
                });
            ...
            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItemVote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "WorkItemId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ux_work_item_votes_tenant_item_user");

                    b.ToTable("work_item_votes", (string)null);
                });

            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItemWatcher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItemWorklog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("work_item_worklogs", (string)null);
                });
            ...
            modelBuilder.Entity("Orbit.Domain.Access.ProjectGroupRoleAssignment", b =>
                {
                    b.HasOne("Orbit.Domain.Access.Role", null)
                        .WithMany()
                    ...
                    b.OwnsMany("Orbit.Domain.Boards.BoardColumn", "Columns", b1 =>
                        {
                            ...
                            b1.HasKey("tenant_id", "project_id", "StatusId");
                            ...
                            b1.HasOne("Orbit.Domain.Configuration.WorkItemStatusDefinition", null)
                                .WithMany()
                                .HasForeignKey("tenant_id", "project_id", "StatusId")
            ...
            modelBuilder.Entity("Orbit.Domain.Configuration.CustomFieldDefinition", b =>
                {
                    ...
                    b.OwnsMany("Orbit.Domain.Configuration.CustomFieldChoiceOption", "ChoiceOptions", b1 =>
                        {
                            b1.Property<Guid>("tenant_id")
                                .HasColumnType("uuid")
                                .HasColumnName("tenant_id");

                            b1.Property<Guid>("custom_field_definition_id")
                                .HasColumnType("uuid")
                                .HasColumnName("custom_field_definition_id");
                            ...
                            b1.HasKey("tenant_id", "custom_field_definition_id", "Id");

                            b1.ToTable("custom_field_choice_options", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("tenant_id", "custom_field_definition_id");
                        });
            ...
            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItem", b =>
                {
                    ...
                    b.HasOne("Orbit.Domain.Configuration.WorkItemStatusDefinition", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "ProjectId", "StatusId")
                        .HasPrincipalKey("TenantId", "ProjectId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Orbit.Domain.WorkItems.WorkItemCustomFieldValue", b =>
                {
                    b.HasOne("Orbit.Domain.Configuration.CustomFieldDefinition", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "CustomFieldDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
