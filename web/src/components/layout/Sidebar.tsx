      ...
      <aside className={`fixed inset-y-0 left-0 pt-14 w-[240px] bg-white border-r border-gray-200 flex flex-col z-10 transition-transform ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
        <div className="flex-1 overflow-y-auto py-4 custom-scrollbar">
          ...
          <nav className="px-3 space-y-0.5">
            <button type="button" className="w-full text-left flex items-center gap-3 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-md text-sm font-medium">
          ...
          <div className="mt-6">
            ...
            <nav className="px-3 space-y-0.5">
              <button type="button" className="w-full text-left flex items-center gap-3 px-3 py-2 bg-blue-50 text-blue-700 rounded-md text-sm font-medium">
        ...
        <div className="p-4 border-t border-gray-200">
          <button type="button" className="w-full text-left flex items-center gap-3 text-gray-700 hover:text-gray-900 text-sm font-medium">
