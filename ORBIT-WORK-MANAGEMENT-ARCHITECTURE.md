...
| Workspace settings | General details, members, teams, roles, invitations, security, integrations, billing | General defaults, workspace typography settings (v1.23), member role lifecycle, teams, and the invitation issue/list/revoke UI are implemented with RLS and admin enforcement (v1.10/v1.16) | Add security, integration, and billing modules, audit and authorization-epoch invalidation |
